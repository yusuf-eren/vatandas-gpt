...
const SignIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError((err as AxiosError<{message?: string}>)?.response?.data?.message || t('auth.invalidCredentials'));
    } finally {
      setIsLoading(false);
    }
  };
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-4 bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-slate-500/20 focus:border-slate-600 transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-4 pr-12 bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-slate-500/20 focus:border-slate-600 transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
